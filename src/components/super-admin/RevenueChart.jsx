...
export default function RevenueChart() {
    ...
    const fetchRevenueData = async () => {
        ...
        try {
            ...
            const chartData = [
                { name: "En période d'essai", value: counts.trial, color: '#10B981', description: 'Starter - 14 jours d\'essai' },
                { name: 'Gratuit', value: counts.free, color: '#9CA3AF', description: 'Plan Free' },
                { name: 'Starter (payant)', value: (counts.starter || 0) - counts.trial, color: '#3B82F6', description: '49€/mois' },
                { name: 'Business', value: counts.business, color: '#8B5CF6', description: '99€/mois' }
        ...
        if (data.length === 0) {
            return (
                <div className="h-64 flex items-center justify-center">
                    <p className="text-gray-400 dark:text-gray-500">Aucune donnée disponible</p>
                </div>
            );
        }
    ...
    return (
        ...
        >
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h2 className="text-xl font-bold text-gray-800 dark:text-white">Analyse des abonnements</h2>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Répartition des entreprises par statut</p>
                </div>
                ...
                <>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
                        ...
                        <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 rounded-xl p-3">
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400">Starter (14j)</p>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/30 dark:to-pink-900/30 rounded-xl p-3">
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400">Starter/Business</p>
                        </div>

                        <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 rounded-xl p-3">
                            <p className="text-xs text-gray-600 dark:text-gray-400 font-medium mb-1">Gratuit</p>
                            <p className="text-lg font-bold text-gray-800 dark:text-gray-300">{stats.freeCompanies}</p>
                            <p className="text-xs text-gray-500 dark:text-gray-400">Plan Free</p>
                        </div>
                    </div>
                    ...
                    <div className="mt-4 p-3 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-xl border border-blue-100 dark:border-gray-700">
                        <div className="flex items-center justify-between">
                            <span className="text-sm text-gray-600 dark:text-gray-300">Revenus mensuels potentiels</span>

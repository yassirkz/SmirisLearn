                                    ...
                                    {[1, 2, 3, 4, 5].map(col => (
                                        <td key={col} className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                {col === 2 && <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-16 animate-pulse" />}
                                                {col === 3 && <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-16 animate-pulse" />}
                                                {col === 4 && <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-24 animate-pulse" />}
                                                {col === 5 && <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-12 ml-auto animate-pulse" />}
                                            </div>
                                        </td>
                                    ))}
                                </tr>

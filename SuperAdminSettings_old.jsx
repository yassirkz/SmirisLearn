...
export default function SuperAdminSettings() {
    ...
    const handleSavePlatformConfig = async () => {
        ...
        try {
            ...
            setSuccess('Configuration plateforme sauvegard├®e');
        } catch (error) {
    ...
    const handleSaveProfile = async () => {
        ...
        try {
            ...
            setSuccess('Profil mis ├á jour avec succ├¿s');
        } catch (error) {
    ...
    const handleRefreshStats = async () => {
        ...
        try {
            ...
            setSuccess('Statistiques mises ├á jour');
        } catch (error) {
            console.error('Erreur rafra├«chissement stats:', error);
            setError('Erreur lors de la mise ├á jour des statistiques');
        } finally {
            setRefreshing(false);
        }
    };
    ...
    const handleExportData = async () => {
        ...
        try {
            ...
            const headers = ['Nom', 'Plan', 'Date de cr├®ation'];
            ...
            <MainLayout>
                <div className="min-h-[60vh] flex items-center justify-center">
                    <div className="relative">
                        ...
                        <p className="mt-4 text-gray-500 dark:text-gray-400">Chargement des param├¿tres...</p>
                    </div>
                </div>
            </MainLayout>
        );
            ...
            >
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                        <div className="flex-1">
                            ...
                            <p className="text-lg text-gray-500 dark:text-gray-400 font-medium max-w-2xl flex flex-wrap items-center gap-2">
                                ...
                                G├®rez votre profil et la configuration de la plateforme
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        >
                            ...
                            <div className="mb-6">
                                ...
                                <div className="space-y-3">
                                    {[
                                        ...
                                        { key: 'newCompanyAlert', label: 'Nouvelle entreprise cr├®├®e' },
                            ...
                            <div className="mb-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">Th├¿me</p>
                            ...
                            {/* S├®curit├® */}
                            <div>
                                <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">S├®curit├®</h3>
                                <div>
                            ...
                            <div className="mt-6 p-5 bg-gradient-to-r from-primary-50/80 to-accent-50/80 dark:from-primary-900/20 dark:to-accent-900/20 backdrop-blur-sm rounded-2xl border border-primary-100 dark:border-primary-800/50">
                                <label className="flex items-center justify-between cursor-pointer">
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500 dark:text-gray-400">Permettre les acc├¿s API externes</p>
                                    </div>
                                    <div className="relative">
                                        <input
                                            type="checkbox"
                                ...
                                {platformConfig.api_enabled && (
                                    <div className="mt-3">
                                        <label className="block text-sm text-gray-600 dark:text-gray-400 mb-1">
                                            Limite de requ├¬tes API (par heure)
                                        </label>
                                        <input
                                            type="number"
                        ...
                        >
                            ...
                            <div className="relative z-10 space-y-3">
                                {[
                                    ...
                                    { label: 'Vid├®os', value: platformStats.videos },
                                    { label: 'Stockage utilis├®', value: formatStorage(platformStats.storageUsed) }
                                ].map((stat, i) => (
                            ...
                            <div className="relative z-10 mt-5 pt-4 border-t border-white/20">
                                <div className="flex items-center gap-2 text-sm font-medium">
                                    ...
                                    <span>Tout est op├®rationnel</span>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="space-y-2">
                                ...
                                >
                                    ...
                                    <span>{refreshing ? 'Mise ├á jour...' : 'Rafra├«chir les stats'}</span>
                                </button>
                                <button
                                ...
                                >
                                    ...
                                    <span>{exporting ? 'Exportation...' : 'Exporter les donn├®es'}</span>
                                </button>
                            </div>
                        </motion.div>
                    </div>
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/60 dark:bg-slate-900/40 backdrop-blur-sm rounded-full border border-gray-200 dark:border-gray-800 text-xs text-gray-400 dark:text-gray-500">
                        ...
                        <span>Param├¿tres prot├®g├®s ÔÇó Connexion s├®curis├®e ÔÇó Actions journalis├®es</span>
                    </div>
                </motion.div>
            </motion.div>
        </MainLayout>
